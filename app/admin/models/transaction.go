...
func (ErpFinanceTransaction) TableName() string {
    return "erp_finance_transaction"
}

func (e *ErpFinanceTransaction) Generate() models.ActiveRecord {
	o := *e
	return &o
}

func (e *ErpFinanceTransaction) GetId() interface{} {
	return e.Id
}